    ...
    <div class="container pt-4 pb-4">
        ...
        <form action="{{ route('siswa.prosesSimpan') }}" method="POST">
            ...
            <div class="form-group">
                ...
                <div class="alert alert-danger">{{ $message}}</div>
                @enderror
                <textarea name="alamat" id="alamat" cols="30" rows="2" class="form-control @error('alamat') is-invalid @enderror" value="{{ old('alamat') }}"></textarea>
            </div>
            <div class="form-group">
            ...
            <button name="daftar" id="daftar" class="btn btn-success" type="submit"><b>Daftar</b></button>
            <a href="/datasiswa" class="btn btn-primary"><b>Lihat Data Siswa</b></a>
        </form>
    </div>
